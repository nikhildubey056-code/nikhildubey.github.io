...
.hero-overlay{
  ...
  z-index:1;
  background:
    linear-gradient(105deg, rgba(13,11,9,0.82) 0%, rgba(13,11,9,0.55) 50%, rgba(13,11,9,0.2) 100%),
...
.hero-divider{
  ...
  margin:2.2rem 0;
  animation:expandLine 1.1s 0.95s forwards;
}
.hero-tagline{
  font-size:1.22rem;font-weight:300;font-style:italic;
  color:rgba(250,247,242,0.7);line-height:1.7;max-width:460px;
  opacity:0;animation:fadeUp 0.8s 0.75s forwards;
}
.hero-tagline strong{color:var(--gold-l);font-weight:600;font-style:normal;}
.pill-row{
  display:flex;flex-wrap:wrap;gap:0.55rem;margin-top:2.5rem;
  opacity:0;animation:fadeUp 0.8s 0.95s forwards;
}
.pill{
  font-family:'JetBrains Mono',monospace;font-size:0.6rem;letter-spacing:0.1em;
  padding:0.4rem 1.1rem;border:1px solid rgba(201,168,76,0.3);
  border-radius:100px;color:rgba(250,247,242,0.65);
  background:rgba(201,168,76,0.06);text-transform:uppercase;
  transition:all 0.35s;cursor:default;backdrop-filter:blur(4px);
}
...
.btn{
  ...
  transition:all 0.35s;display:inline-flex;align-items:center;gap:0.6rem;
  border:none;cursor:pointer;
}
.btn-dark{background:rgba(250,247,242,0.1);color:#fff;border:1px solid rgba(250,247,242,0.2);backdrop-filter:blur(8px);}
.btn-dark:hover{background:var(--gold);color:var(--ink);border-color:var(--gold);transform:translateY(-3px);box-shadow:0 12px 30px rgba(201,168,76,0.3);}
.btn-ghost{background:transparent;color:rgba(250,247,242,0.7);border:1px solid rgba(201,168,76,0.3);}
...
nav.scrolled{padding:0.7rem 4rem;background:rgba(13,11,9,0.85);}
.nav-logo{font-family:'Playfair Display',serif;font-size:1.1rem;font-weight:700;color:#fff;text-decoration:none;}
.nav-logo span{color:var(--gold);}
.nav-links{display:flex;gap:2.5rem;list-style:none;align-items:center;}
.nav-links a{
  font-family:'JetBrains Mono',monospace;font-size:0.63rem;letter-spacing:0.18em;
  text-transform:uppercase;color:rgba(250,247,242,0.5);text-decoration:none;
...
.nav-cta{
  font-family:'JetBrains Mono',monospace;font-size:0.62rem;letter-spacing:0.15em;
...
.action-tile{
  padding:2rem 2.2rem;border-right:1px solid rgba(201,168,76,0.06);
...
.action-tile:hover{background:rgba(201,168,76,0.05);}
...
.about-body{font-size:1.12rem;line-height:1.95;color:rgba(250,247,242,0.6);font-weight:300;}
...
.stat{
  border:1px solid rgba(201,168,76,0.12);padding:1.8rem;
...
.art-card{
  background:#1a1410;border:1px solid rgba(201,168,76,0.1);padding:2.2rem;
...
.art-card:hover{transform:translateY(-6px);box-shadow:0 20px 50px rgba(0,0,0,0.4);border-color:rgba(201,168,76,0.35);}
...
.art-title{font-family:'Playfair Display',serif;font-size:1.3rem;font-weight:700;color:#fff;line-height:1.3;margin-bottom:0.8rem;}
.art-excerpt{font-size:0.95rem;color:rgba(250,247,242,0.45);line-height:1.7;font-style:italic;}
.art-footer{display:flex;justify-content:space-between;align-items:center;margin-top:1.8rem;padding-top:1rem;border-top:1px solid rgba(201,168,76,0.1);}
.art-date{font-family:'JetBrains Mono',monospace;font-size:0.58rem;color:rgba(250,247,242,0.3);}
...
.dual-card:first-child{background:#0f1a0f;}
.dual-card:last-child{background:#1a110a;}
.dual-card:hover{transform:scale(1.015);z-index:2;}
.dual-num{
  font-family:'Playfair Display',serif;font-size:8rem;font-weight:900;font-style:italic;
  color:rgba(201,168,76,0.05);position:absolute;top:-1rem;right:2rem;line-height:1;user-select:none;
}
.dual-icon-wrap{
...
.dual-sub{font-family:'JetBrains Mono',monospace;font-size:0.6rem;letter-spacing:0.2em;text-transform:uppercase;color:rgba(201,168,76,0.45);margin-bottom:0.8rem;}
...
.dual-desc{font-size:1.05rem;line-height:1.85;color:rgba(250,247,242,0.5);font-weight:300;}
...
.dual-tag{
  ...
  padding:0.35rem 0.8rem;border:1px solid rgba(201,168,76,0.18);
...
.edu-dot{position:absolute;left:-2.84rem;top:6px;width:8px;height:8px;background:var(--gold);border-radius:50%;box-shadow:0 0 0 3px #111009,0 0 0 4px var(--gold);}
...
.edu-deg{font-family:'Playfair Display',serif;font-size:1.45rem;font-weight:700;color:#fff;margin-bottom:0.3rem;}
.edu-school{font-size:1rem;font-style:italic;color:rgba(250,247,242,0.4);}
.edu-cards{display:flex;flex-direction:column;gap:1.5rem;}
.edu-card{
  background:#1a1410;padding:2.5rem;border-left:3px solid var(--gold);
  opacity:0;transform:translateX(16px);transition:all 0.6s;
}
...
.philosophy::before{
  ...
  font-family:'Playfair Display',serif;font-size:32rem;font-weight:900;
  color:rgba(26,20,16,0.04);line-height:1;pointer-events:none;
}
.phil-quote{
  font-family:'Playfair Display',serif;
  font-size:clamp(1.6rem,2.8vw,2.7rem);font-weight:400;font-style:italic;
  color:var(--ink);line-height:1.45;max-width:880px;margin:0 auto 2rem;
...
.contact-sub{font-size:1.12rem;color:rgba(250,247,242,0.4);font-style:italic;margin-bottom:3.5rem;}
...
.contact-card{
  ...
  border:1px solid rgba(201,168,76,0.12);padding:1.2rem 2rem;transition:all 0.35s;
}
...
.modal{background:#1a1410;border:1px solid rgba(201,168,76,0.2);padding:3rem;max-width:460px;width:90%;position:relative;transform:translateY(20px);transition:transform 0.35s;}
.modal-bg.open .modal{transform:translateY(0);}
.modal-title{font-family:'Playfair Display',serif;font-size:1.8rem;font-weight:700;color:#fff;margin-bottom:0.3rem;}
...
.modal-x{position:absolute;top:1.2rem;right:1.5rem;background:none;border:none;font-size:1.4rem;cursor:pointer;color:rgba(250,247,242,0.4);transition:color 0.2s;}
.modal-x:hover{color:#fff;}
.drop-zone{border:2px dashed rgba(201,168,76,0.2);padding:3rem;text-align:center;position:relative;cursor:pointer;transition:all 0.3s;}
...
.drop-text{font-family:'Cormorant Garamond',serif;font-size:1.05rem;color:rgba(250,247,242,0.5);font-style:italic;}
...
<spline-viewer url="https://prod.spline.design/WLbXlAZg1QbguGNg/scene.splinecode"></spline-viewer>
  ...
  <div class="hero-content">
    <div class="hero-eyebrow">
      ...
      <span class="eyebrow-text">Ranchi, Jharkhand · India</span>
    </div>
...
<div class="action-strip">
  <a href="articles.html" class="action-tile">
    ...
    <div><div class="tile-label">Write Article</div><div class="tile-desc">Share thoughts on UPSC & tech</div></div>
  </a>
  <div class="action-tile" onclick="openModal()">
    <div class="tile-icon">📸</div>
    <div><div class="tile-label">Upload Photo</div><div class="tile-desc">Add your profile picture</div></div>
  </div>
  <a href="#articles" class="action-tile">
    <div class="tile-icon">📚</div>
    <div><div class="tile-label">My Articles</div><div class="tile-desc">Browse published writings</div></div>
  </a>
  <a href="https://www.linkedin.com/in/nikhildubey01" target="_blank" class="action-tile">
    <div class="tile-icon">🔗</div>
...
<section class="about" id="about">
  <div class="about-grid">
    <div>
      ...
      <a href="#identity" class="btn btn-ghost" style="margin-top:2rem;display:inline-flex;font-size:0.62rem;padding:0.75rem 1.6rem;border-color:rgba(201,168,76,0.3);color:rgba(201,168,76,0.8);">Explore my identity →</a>
    </div>
    <div>
...
<section class="articles-section" id="articles">
  <div class="arts-header">
    ...
    <a href="articles.html" class="btn btn-gold">✍ Write New Article</a>
  </div>
  <div class="articles-grid" id="articlesGrid">
    <div class="empty-arts">
      <p>Your articles will appear here once published.</p>
      <a href="articles.html" class="btn btn-gold">✍ Write Your First Article</a>
    </div>
  </div>
</section>
...
<div class="dual" id="identity">
  <div class="dual-card">
    ...
    <div class="dual-tags">
      <span class="dual-tag">Python</span><span class="dual-tag">C</span>
      <span class="dual-tag">Machine Learning</span><span class="dual-tag">Algorithms</span>
      <span class="dual-tag">DSA</span><span class="dual-tag">Networking</span><span class="dual-tag">OS</span>
    </div>
  </div>
  <div class="dual-card">
    ...
    <div class="dual-tags">
      <span class="dual-tag">Sociology</span><span class="dual-tag">General Studies</span>
      <span class="dual-tag">Polity</span><span class="dual-tag">History</span>
      <span class="dual-tag">Governance</span><span class="dual-tag">Public Policy</span>
    </div>
  </div>
</div>
  ...
  <div class="edu-grid">
    <div class="edu-timeline">
      <div class="edu-item">
        ...
        <div class="edu-deg">Master of Computer Applications</div>
        <div class="edu-school">Marwari College, Ranchi · Computer Science</div>
      </div>
      <div class="edu-item">
        <div class="edu-dot"></div>
        <div class="edu-year">May 2021 — May 2024</div>
        <div class="edu-deg">Bachelor of Applied Science</div>
        <div class="edu-school">Gossner College, Ranchi · Information Technology</div>
      </div>
      <div class="edu-item">
        <div class="edu-dot"></div>
        <div class="edu-year">July 2019 — July 2021</div>
        <div class="edu-deg">Intermediate · Class XII</div>
        <div class="edu-school">St. Xavier's College, Ranchi · Science</div>
      </div>
    </div>
    <div class="edu-cards">
      <div class="edu-card">
        <div class="edu-card-label">Current Focus</div>
        <div class="edu-card-text">"Bridging computational thinking and civil service understanding — using code to analyze governance, and sociology to humanize technology."</div>
      </div>
      <div class="edu-card">
        <div class="edu-card-label">Mentorship</div>
        <div class="edu-card-text">"Currently a Mentorship Trainee at Addictive Learning Technology Limited — learning how technology can transform education."</div>
      </div>
      <div class="edu-card">
        <div class="edu-card-label">The Journey</div>
        <div class="edu-card-text">"From St. Xavier's science classrooms to MCA labs — and simultaneously into the world of UPSC. Two paths, one purpose."</div>
      </div>
    </div>
  </div>
</section>
...
<section class="contact" id="contact">
  ...
  <div class="contact-row">
    <a href="mailto:nikhildubey056@gmail.com" class="contact-card">
      <span class="contact-card-icon">✉</span>nikhildubey056@gmail.com
    </a>
    <a href="https://www.linkedin.com/in/nikhildubey01" target="_blank" class="contact-card">
      <span class="contact-card-icon">in</span>linkedin.com/in/nikhildubey01
    </a>
    <div class="contact-card">
      <span class="contact-card-icon">📍</span>Ranchi, Jharkhand, India
    </div>
  </div>
...
<div class="modal-bg" id="photoModal">
  <div class="modal">
    ...
    <div class="modal-btns">
      ...
      <button class="mbtn" onclick="removePhoto()" style="color:#8b3a2a;border-color:rgba(139,58,42,0.3);">Remove Photo</button>
    </div>
  </div>
</div>
...
animRing();
document.querySelectorAll('a,button,.action-tile,.pill,.stat,.art-card,.dual-card').forEach(el=>{
...
window.addEventListener('scroll',()=>{
  ...
  let curSec='';const nh=navEl.offsetHeight;
